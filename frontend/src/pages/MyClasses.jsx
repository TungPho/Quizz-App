...
const MyClasses = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Main content */}
      <div className="md:ml-[250px] px-4 md:px-8 pt-6 pb-12 transition-all duration-300">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
          ...
          <button
            ...
            className="flex items-center justify-center w-full sm:w-auto bg-green-400 text-white rounded-md hover:bg-green-500 py-2 px-4 transition-colors"
          >
